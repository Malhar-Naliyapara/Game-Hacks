...
<html lang="en">
<head>
<title>Cheats Zone A Games Category Flat Bootstrap responsive Website Template | Contact :: w3layouts</title>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="hover-effect active"><a href="contact.php">Contact</a></li>
					</ul>
				</div>
