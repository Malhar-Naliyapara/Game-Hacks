...
<html lang="en">
<head>
<title>Cheats Zone A Games Category Flat Bootstrap responsive Website Template | About :: w3layouts</title>
			...
			<div class="container">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="hover-effect active"><a href="about.php">About</a></li>
...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-4 footer-right-w3">
			<a href="index.php"><h4>Cheats <img src="images/f1.png" alt=" " /> Zone</h4></a>
