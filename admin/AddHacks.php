				...
				<div class="content">
					...
					<div class="module">
						<div class="module-head">
							<h3 style="float: left;">Add Hacks</h3>
						...
						<div class="module-body">
							...
							<form class="form-horizontal row-fluid" action="Controller/con_AddHacks.php" method="POST" enctype="multipart/form-data">
								<div class="control-group">
									<label class="control-label" for="basicinput">Hack Title</label>
									<div class="controls">
										<input type="text" id="basicinput" name="HackTitle" placeholder="Enter Hack Title" class="span8">
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<textarea class="span8" rows="5" name="HackDescription"></textarea>
									</div>
								</div>
								<div class="control-group">
