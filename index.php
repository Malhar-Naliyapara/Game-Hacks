...
<html lang="en">
<head>
<title>Game Hacks : This is the place where you can find the all hacks for the games</title>
	...
	<div class="header">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			<div class="container">
				...
				<div class="navbar-header">
					...
					<a  href="index.php">
					<h1 style="color: #000; margin-top: 0.05em;"><img src="images/technology.png" style="width: 60px"> Game Hacks</h1>
					</a>
				</div>
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="hover-effect"><a href="contact.php">Contact</a></li>
					</ul>
				</div>
		...
		<div class="slider">
			<ul class="rslides" id="slider">
				<li>
					<img src="images/Game Images/banner1.jpg" alt="" />
				</li>
				<li>
					<img src="images/Game Images/banner2.jpg" alt="" />
				</li>
				<li>
					<img src="images/Game Images/banner3.jpg" alt="" />
				</li>
				<li>
					<img src="images/Game Images/banner4.jpg" alt="" />
				</li>
			</ul>
		</div>
		<!-- //Slider -->
...
<div class="trend-w3layouts">
	<div class="container">
		<h2 style="color: #000;">Trending Games</h2>
		<ul id="flexiselDemo1">			
				<li>
...
<div class="footer">
	<div class="container">
		...
		<div class="col-md-4 footer-right-w3">
			<a href="index.html"><h4>Cheats <img src="images/f1.png" alt=" " /> Zone</h4></a>
		...
		<div class="clearfix"></div>
		<div class="copyright">
			<p>&copy; 2017 Cheats Zone. All Rights Reserved | Design by <a href="http://w3layouts.com/" target="_blank"> W3layouts </a></p>
		</div>
	</div>
</div>
